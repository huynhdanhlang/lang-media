...
const categoryJson = fs.readFileSync(__dirname + pathDependPlatform('category.json'), 'utf8');
const categoryData = JSON.parse(categoryJson).data;
const videoJson = fs.readFileSync(__dirname + pathDependPlatform('video.json'), 'utf8');
const videoData = JSON.parse(videoJson).data;
const tagJson = fs.readFileSync(__dirname + pathDependPlatform('tag.json'), 'utf8');
